...
详细信息随项目不同，稿件要求沿用线上行为；示例列出标题、时间、尺寸、方向、大小、拍摄设备及路径，字段集合随媒体项目变化。
...
批注明确：上线以开发排期为准；部分媒体类型下入口隐藏。扫描能力按目标设备和版本确认。精确适用类型与当前入口需核对原图和实际版本。
...
普通照片编辑器和壁纸设置完整流程未提供；删除行为按当前来源相册对应的规则核对。
